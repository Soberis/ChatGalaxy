<template>
  <div class="home-view">
    <!-- 未登录状态：显示认证表单 -->
    <AuthForm v-if="!isAuthenticated" @login="handleLogin" @register="handleRegister" @guest-mode="handleGuestMode" />
    ...
    <div v-else class="chat-container">
      ...
      <main class="chat-main flex-1 overflow-hidden">
        <ChatInterface :current-user="currentUser" :is-guest="isGuest" @role-change="handleRoleChange" />
      </main>
    </div>
  </div>
</template>
